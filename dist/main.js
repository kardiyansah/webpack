...
var run = function run(alertService, calculatorService, jokesService) {
  ...
  calculatorService.onClick(function () {
    ...
    var angka = _utils_parseInput_js__WEBPACK_IMPORTED_MODULE_0__.parseInput.apply(void 0, _toConsumableArray(input));
    if (_utils_cekInputValid_js__WEBPACK_IMPORTED_MODULE_1__.cekInputValid.apply(void 0, _toConsumableArray(angka))) {
